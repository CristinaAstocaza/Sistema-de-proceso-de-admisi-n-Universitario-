error id: file:///D:/CURSOS/7MO/Desarrollo_we/proceso_uni/src/main/java/pe/edu/proceso_admision/controller/OmrProcesoController.java:_empty_/AuditoriaService#
file:///D:/CURSOS/7MO/Desarrollo_we/proceso_uni/src/main/java/pe/edu/proceso_admision/controller/OmrProcesoController.java
empty definition using pc, found symbol in pc: _empty_/AuditoriaService#
empty definition using semanticdb
empty definition using fallback
non-local guesses:

offset: 1166
uri: file:///D:/CURSOS/7MO/Desarrollo_we/proceso_uni/src/main/java/pe/edu/proceso_admision/controller/OmrProcesoController.java
text:
```scala
...
public class OmrProcesoController {
    ...
    private final Auditori@@aService auditoriaService;
